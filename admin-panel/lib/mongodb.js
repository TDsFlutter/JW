...
export async function getClient() {
  if (!uri) {
    throw new Error('MONGODB_URI is not set. Add it to admin-panel/.env.local');
  }
...
// Emulates MySQL AUTO_INCREMENT: atomically returns the next integer id
// for the given sequence name (stored in the `counters` collection).
